...
public class Q13 extends GenericQuery {
  ...
  // The 1/364 factor corresponds to the D_WEEKNUMINYEAR and D_YEAR field (7 years, 53 weeknum
  // values = 365)
  // The 3/11 factor corresponds to the LO_DISCOUNT field
  // the 1/10 factor corresponds to the LO_QUANTITY field, so the bounds need to cover 5 consecutive
  // quantity values
